try {
    ...
    $.ajax({url: "./assets/waifu-tips.js", dataType:"script", cache: true, success: function(res) {
        
        $.ajax({url: "./assets/live2d.js", dataType:"script", cache: true, success: function(res) {
            /* 可直接修改部分参数 */
